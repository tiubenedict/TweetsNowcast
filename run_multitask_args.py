...
parser.add_argument("--config", type=str, default=None, help="Python module path to a trial config, e.g. configs.mt_nobiasTE_v1. If omitted, uses the legacy hardcoded sweep.")
